...
Documentation.ai has three user roles for organization members:
...
- Create, edit, and delete documentation content

- Publish documentation and manage branches

- Manage the file tree (create, rename, move, and delete files)

- Participate in comments and threads

- Cannot manage team members or organization settings

- Cannot delete or manage the organization
...
- Open the editor in read-only mode to see real-time changes from other collaborators

- Participate in comments and threads (create, reply, resolve, and reopen)

- View and manage their own notifications

- Cannot make any changes to documentation content
...
<Callout kind="info">
  ...
  Role changes may take up to two minutes to take effect in the editor due to permission caching. If a teammate's permissions do not update immediately after a role change, wait a few minutes and try again.
...
5. Select the role (Admin, Editor, or Viewer)
...
4. Choose new role (Admin, Editor, or Viewer)
...
- Editors can create, edit, and publish documentation across all projects
...
- **Use Editor role for**: Writers, developers, and contributors who need to edit and publish documentation but do not need to manage the organization
