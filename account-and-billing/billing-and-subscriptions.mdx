...
The Enterprise plan is designed for larger organizations that need more seats, documentation sites, and AI credits. It is available at $499/month with a yearly billing option.

- **Price**: $499/month (yearly billing also available)

- **AI credits**: 50,000 per month

- **Documentation sites**: 5

- **Editor seats**: 20

- **API key generation**: Included for programmatic access

- **Payment options**: Credit/debit cards and bank transfers

<Callout kind="info">

The Enterprise plan is sales-led. Contact the Documentation.AI team to get started or to discuss custom requirements beyond the standard Enterprise limits.
