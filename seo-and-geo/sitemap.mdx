...
<Callout kind="info" collapsed="false">
  ...
  The sitemap always reflects your public **published** content state. When you publish new pages, rename or move existing ones, or unpublish content, the sitemap updates to match. Each URL in the sitemap also includes an accurate `lastModified` date based on when that page was last edited, giving search engines precise freshness signals for every page.
