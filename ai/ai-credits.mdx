...
<Callout kind="info" collapsed="false">
  ...
  Credits reset every billing cycle. Up to 50% of unused subscription credits carry forward to the next cycle, capped at 1.5× your monthly allocation.
...
The [AI Documentation Agent](/ai/ai-documentation-agent) helps you create, edit, and organize documentation. Documentation.AI recently upgraded the writer and code analysis model stack, so more capable models can improve output quality, but complex tasks may use more credits as a result.
...
<Callout kind="info" collapsed="false">
  ...
  If you run out of both subscription credits and pack credits, and overage is not enabled or the overage limit has been reached, the AI Documentation Agent and AI Assistant features will be disabled until your next billing cycle, until you purchase a credit pack, or until you upgrade your plan.
...
In addition to the monthly credits included with your plan, you can purchase **credit packs** as an add-on. Credit packs provide a fixed number of additional credits that are consumed after your monthly subscription credits run out.

- Credit packs are available in several sizes (5,000 to 100,000 credits)
- Pack credits are used automatically after your subscription credits are exhausted
- Pack credits persist until depleted — they are not lost at the end of a billing cycle
- Trial accounts receive 10,000 pack credits that expire after 14 days

To purchase a credit pack, go to **Settings → Organization Settings → Billing** and select the pack size that fits your needs.

## Overage usage

If you have an active subscription with a payment method on file, you can enable **overage usage** to continue using AI features after both your subscription and pack credits are exhausted. Overage credits are billed at $0.01 per credit and are charged through Stripe at the end of each billing cycle.

You can set a monthly **overage spending limit** (in USD) to control how much you are charged. When the overage limit is reached, AI features are paused until the next billing cycle — no additional charges are incurred.

<Callout kind="tip" collapsed="false">

  Credit packs are consumed before overage credits. If you have both pack credits and overage enabled, pack credits are used first, and overage only applies once pack credits are also exhausted.
