...
Pack credits are additional credits that you can purchase separately on top of your monthly plan allowance. Documentation.AI uses pack credits only after your monthly plan credits run out. Unlike plan credits, pack credits carry over and do not expire at the end of the billing cycle.

<Callout kind="info" collapsed="false">

  Pack credits extend your available credits beyond your plan's monthly allowance. They are consumed after your plan credits are used up, so you will not be charged overage rates while pack credits remain.
...
If you have exhausted your plan credits and pack credits, additional AI usage is billed as overage at $0.01 per credit, provided overage is enabled for your account.

You can set a spending cap (overage limit) in your billing settings to control the maximum overage cost per billing cycle. Once the cap is reached, AI features are paused for the remainder of the cycle.

If overage is disabled on your account, AI features are paused as soon as all plan credits and pack credits are exhausted.

<Callout kind="info" collapsed="false">

  AI features remain available as long as any credits remain — whether from your monthly plan, a credit pack, or enabled overage. Features are only paused when all available credit pools are exhausted and no overage is configured.
