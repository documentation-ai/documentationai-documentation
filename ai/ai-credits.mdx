...
Credit allowances vary by plan.
...
<Callout kind="info" collapsed="false">
  On the Enterprise plan (50,000 credits), your users can ask up to 500,000 questions per month through the AI Assistant, and the Documentation Agent can handle large multi-page tasks regularly without approaching the limit.
</Callout>
...
<Callout kind="info" collapsed="false">
  If you run out of credits, the AI Documentation Agent and AI Assistant features will be disabled until your next billing cycle, until you upgrade your plan, or until you purchase additional credit packs.
</Callout>
