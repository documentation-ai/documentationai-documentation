...
<Callout kind="info" collapsed="false">
  ...
  When you exhaust your plan credits, AI features are disabled until your next billing cycle or until you upgrade your plan. If you have purchased an overage allowance, credits are deducted from your overage pool. Once the overage limit is reached, all AI operations are blocked — no credits are deducted and no background tasks run until credits are replenished.
