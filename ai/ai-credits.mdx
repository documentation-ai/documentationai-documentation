...
<Callout kind="info" collapsed="false">
  ...
  If you use all available AI credits, the AI Documentation Agent and AI Assistant features will be disabled until credits become available again. Documentation.AI checks all credit sources together: your plan credits, any purchased credit packs, and any enabled overage allowance. If you have purchased credit packs, Documentation.AI uses those after your plan credits are depleted, and AI features remain available until those packs are also exhausted.

</Callout>

When you configure an overage spending limit and that limit is reached, AI usage stops immediately. Any background AI run that is still in progress stops cleanly before its changes are committed, and you receive a notification. This prevents charges from exceeding your configured overage cap.
