...
<Steps>
  ...
  <Step title="Choose a template" icon="plus" title-type="p">
    ...
    Pick the template that matches the task you want to automate. For example, choose **Navigation Audit** for content health checks or **Documentation Update from Code** when documentation changes depend on repository activity.
...
<Callout kind="alert" collapsed="false">
  ...
  - **Broken Link Audit** and **Grammar and Typo Check** templates are temporarily disabled and will be re-enabled in a future release
