...
If your organization reaches its credit overage spending limit while a workflow run is in progress, the run stops before its changes are committed and you receive a notification. Changes are not applied when a run is stopped at this point.
