...
- **SVG handling:** SVG files are served in their native vector format to preserve interactive elements such as embedded links, hover states, and CSS animations. Raster formats (JPEG, PNG, GIF, etc.) are automatically converted and compressed for optimal delivery.
