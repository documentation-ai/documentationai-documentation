...
The expand and collapse toggle buttons now use updated padding and a more consistent visual hierarchy for a cleaner look. Content inside an expandable now mounts only when open and unmounts when closed, instead of staying hidden with CSS. This makes toggling feel smoother and reduces DOM weight when sections are collapsed.
