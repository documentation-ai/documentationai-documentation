...
<Columns cols={2}>
  ...
  <Card title="SVG" href="/components/svg" icon="shapes" horizontal={false}>

    Embed inline scalable vector graphics for icons, logos, and lightweight diagrams.
...
<Columns cols={2}>
  ...
  <Card title="Board" href="/components/board" icon="kanban" horizontal={false}>

    Present roadmaps, feature status, and release plans in a kanban-style column layout.
...
- **Inline icons, logos, and lightweight vector graphics** — SVG
