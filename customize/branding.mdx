...
You can hide the Documentation.AI footer branding from your documentation site by enabling white-label mode. This is available as a paid add-on for Standard and Professional plans.

### How white-label works

When white-label is enabled for a documentation site, the "Powered by Documentation.AI" footer is removed from that site. The change takes effect immediately — no redeployment is needed.

<Callout kind="info" collapsed="false">

  When you purchase the remove-branding add-on, white-label is automatically enabled on all existing documentation sites in your organization. You can toggle it off for individual sites at any time.

</Callout>

### Purchasing the remove-branding add-on

The remove-branding add-on is a monthly subscription item added to your existing plan billing. To purchase it:

1. Go to **Settings** → **Organization Settings** → **Billing**.

2. Select the **Remove Branding** add-on.

3. Confirm the purchase. The add-on is prorated and added to your current billing cycle.

<Callout kind="alert" collapsed="false">

  The remove-branding add-on requires a Standard or Professional plan and an active subscription. You cannot purchase it on the Starter plan.

</Callout>

### Toggling white-label per site

After purchasing the add-on, you can control which individual documentation sites display branding:

- **Enable** white-label for a site to hide the footer branding.
- **Disable** white-label for a site to show the footer branding again.

Changes are applied instantly to your live site without requiring a redeployment.

<Callout kind="info" collapsed="false">

  Toggling white-label requires an organization admin role. The remove-branding add-on must be active on your organization.
